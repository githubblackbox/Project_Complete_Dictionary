...
<br>
<div align="center">
<form action="Register.jsp"  method="post"  style="max-width:500px;margin:auto">
...
<div align="center">
 ...
 <p><h2><font color="white"><%=request.getAttribute("Registered")%></font></h2></p>
 <% } %>
 
 
 <%if(request.getAttribute("incorrect")!=null){ %>
 <p><h2><font color="white"><%=request.getAttribute("incorrect")%></font></h2></p>
 <% } %>
